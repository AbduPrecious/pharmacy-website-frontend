                  ...
                  <div key={menu.id} className="relative group">
                    {dropdownItems.length > 0 ? (
                      <div className="relative group">
                        {/* Different handling based on menu title */}
                        {menu.attributes.title === 'Vacancy' ? (
                          // Vacancy - redirect to careers
                          <Link 
                            href="/careers"
                          ...
                          // Group Companies and R&D - disabled main link
                          <div className="flex items-center">
                          ...
                          // Other dropdown items (like Products) - clickable main link with dropdown arrow
                          <div className="flex items-center">
                            <Link 
                        ...
                        {/* Dropdown menu - show for all except Vacancy */}
                        {menu.attributes.title !== 'Vacancy' && (
