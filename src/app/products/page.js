...
export default function ProductsPage() {
  ...
  const fetchProducts = async () => {
    try {
      const response = await axios.get(`${API_URL}/api/products?populate[category]=*&populate[image]=*`, {
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-8">
          <div className="flex items-center gap-4">
            ...
            <select
              ...
              className="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#FFFF00] focus:border-transparent outline-none text-gray-900 bg-white"
            >
